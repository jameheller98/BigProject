...
// Schema
const Schema = mongoose.Schema; // require schema of mongoose
// create new schema save field
const SignModelSchema = new Schema({
  firstname: {
    type: String, // Loại
  ...
  password: {
    ...
    validate: {
      ...
      message: `Trường "Mật khẩu" phải có ít nhất 8 kí tự
      (1 chữ hoa, 1 chữ thường, 1 kí tự đặc biệt, 1 số)!`,
    },
